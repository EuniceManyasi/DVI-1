...
Modules::run('secure_tings/is_logged_in');
    ...
    $this->form_validation->set_rules('national', 'National', 'required|xss_clean');
    $this->form_validation->set_rules('regional', 'Region', 'required|xss_clean');
    $this->form_validation->set_rules('countyuser', 'County', 'required|xss_clean');
    $this->form_validation->set_rules('subcountyuser', 'Sub County', 'required|xss_clean');
    $this->form_validation->set_rules('facilityuser', 'Facility', 'required|xss_clean');
