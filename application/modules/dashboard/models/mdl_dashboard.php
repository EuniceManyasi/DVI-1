...
function getChart()
{
$query = $this->db->query("SELECT DISTINCT `Vaccine` AS Vaccine, SUM(`Stock_Balance`) AS Stock_balance 
FROM vaccine_stockbalance
GROUP BY `Vaccine`");
...
function getData()
{
$query = $this->db->query("SELECT Months, Above2yrs, Above1yr 
FROM children_immunized");
