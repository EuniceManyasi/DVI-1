...
// Remove a row from the form
           ...
           $("#physical_stock_fm").submit(function(e)
         {
		   ...
		   var formURL="http://localhost/DVI/stock/save_physical_count";
		   		...
		   		var get_count=physical_count[i];
					    ...
					    $.ajax(
					    {
					     ...
					     success:function(data, textStatus, jqXHR) 
						    ...
						    console.log(data);
					        	window.location.replace('http://localhost/DVI/stock/list_inventory');
		...
		function batch_details(selected_batch,stock_row){
					//var _url="<?php echo base_url();?>stock/get_batch_details";
                                        var _url="http://localhost/DVI/stock/get_batch_details";
